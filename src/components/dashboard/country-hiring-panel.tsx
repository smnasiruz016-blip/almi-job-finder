...
import type { CountryHiringHighlights, JobSourceLink } from "@/types";
...
export function CountryHiringPanel({ title, description, highlights, trustedSources, compact = false }: CountryHiringPanelProps) {
