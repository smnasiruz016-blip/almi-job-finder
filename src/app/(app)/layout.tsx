...
import { LayoutTemplate, PenSquare, UserRound } from "lucide-react";
        ...
        <div className="grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
          ...
          <div className="space-y-6">
            <header className="glass-panel flex flex-col gap-4 rounded-[2rem] px-5 py-4 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="font-[family-name:var(--font-display)] text-2xl font-bold text-slate-950">Almi CV Builder</p>
                <p className="text-sm text-slate-500">Create a professional CV, pair it with a matching cover letter, and keep polished drafts ready to export.</p>
              </div>
